...
export default function Footer() {
  return (
    <footer className="bg-primary-dark text-gray-100">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><Link to="/loan-packages" className="hover:text-accent transition-colors">Loan Packages</Link></li>
              <li><Link to="/eligibility" className="hover:text-accent transition-colors">Eligibility</Link></li>
              <li><Link to="/repayment" className="hover:text-accent transition-colors">Repayment & Fees</Link></li>
          ...
          <div>
            ...
            <div className="mt-6 space-y-2">
              <a href="mailto:support@innbucksloans.co.zw" className="flex items-center space-x-2 text-sm hover:text-accent transition-colors">
                <Mail className="h-4 w-4" />
                <span>support@innbucksloans.co.zw</span>
              </a>
              <a href="https://wa.me/263771234567" className="flex items-center space-x-2 text-sm hover:text-accent transition-colors">
        ...
        <div className="border-t border-primary-light mt-8 pt-8 text-sm text-center text-gray-300">
